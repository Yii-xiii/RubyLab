...
#       post collections_url, params: { collection: { product_id: @collection.product_id, user_id: @collection.user_id } }
#     end
...
#     patch collection_url(@collection), params: { collection: { product_id: @collection.product_id, user_id: @collection.user_id } }
